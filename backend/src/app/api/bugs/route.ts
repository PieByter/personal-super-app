...
export async function PUT(req: NextRequest) {
    ...
    try {
        ...
        const [updated] = await db
            ...
            .where(and(eq(bugEntries.id, id), eq(bugEntries.userId, user.userId)))
            .returning();
...
export async function DELETE(req: NextRequest) {
    ...
    try {
        ...
        await db.delete(bugEntries).where(and(eq(bugEntries.id, id), eq(bugEntries.userId, user.userId)));
